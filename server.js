...
require("./app/routes/sushi.routes")(app);
require("./app/routes/pizza.routes")(app);
require("./app/routes/desert.routes")(app);
require("./app/routes/drink.routes")(app);
require("./app/routes/kombo.routes")(app);
require("./app/routes/sous.routes")(app);
require("./app/routes/zakuski.routes")(app);
